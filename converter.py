...
class ConverterCurrencies(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.title = Label(self, text='KANTOR', bg='grey', fg='white', relief=RAISED, borderwidth=3, font=font).place(
            x=360,y=0)

        self.date = Label(self, text=f"Date : {self.currency_converter.data['date']}", relief=SUNKEN,
                                borderwidth=5).place(x=345, y =50)

        valid = (self.register(self.restrictNumberOnly), '%d', '%P')


        # Used get info method
        ...
        self.converted_field = Label(self, text='', fg='black', bg='white', relief=RIDGE,justify=CENTER, width=17, borderwidth=3)
        ...
        self.from_full_name = Label(self, text="Polish Zloty", fg='black', bg='white', relief=RIDGE,justify=CENTER,
                                    width=17,
                                    borderwidth=3)
        self.to_full_name = Label(self, text="United States Dollar", fg='black', bg='white', relief=RIDGE,justify=CENTER, width=17,
                                    borderwidth=3)
        ...
        self.convert_button = Button(self, text="Convert", fg="black", command=self.perform).place(x=370, y=100)
