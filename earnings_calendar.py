...
class EarningsCalendar(Frame):
    def __init__(self, *args, **kwargs):
        ...
        Label(self, text="Earnings Calendar", bg='grey', fg='white', relief=RAISED, borderwidth=3,
              font=fonty).place(x=300, y=10)

        Label(self, text="SYMBOL", bg='grey', fg='white', relief=RAISED, borderwidth=3, font=font).place(
            x=0, y=50)

        Label(self, text="NAME", bg='grey', fg='white', relief=RAISED, borderwidth=3, font=font).place(
            x=260, y=50)

        Label(self, text="REPORT DATE", bg='grey', fg='white', relief=RAISED, borderwidth=3,
              font=font).place(x=490, y=50)

        Label(self, text="ESTIMATE", bg='grey', fg='white', relief=RAISED, borderwidth=3,
              font=font).place(x=610, y=50)

        Label(self, text="CURRENCY", bg='grey', fg='white', relief=RAISED, borderwidth=3,
